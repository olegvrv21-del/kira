...
installFetchInterceptor();
    ...
    function setNav(name) {
      ...
      const isExperiments = name === 'experiments';
      const experimentsView = document.getElementById('experiments-view');
      if (experimentsView) experimentsView.style.display = isExperiments ? 'block' : 'none';
      const hideMain = isDash || isModels || isActions || isMetrics || isExperiments;
      ...
      if (isExperiments) experiments.load();
